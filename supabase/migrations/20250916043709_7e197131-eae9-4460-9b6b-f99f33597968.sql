-- Fix driver order acceptance issues
-- Update the get_driver_orders function to ensure accepted orders are properly returned
...
BEGIN
  ...
  FROM public.orders o
  WHERE 
    -- ALWAYS show orders assigned to this driver (regardless of status)
